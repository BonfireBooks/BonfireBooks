        ...
        if(userBook[position].getOwner().equals(user.getUid())) {
            ...
            btn_edit_book.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {;
                    UserProfileBook userProfileBook = new UserProfileBook(userBook[position].getBookId(), book.getTitle(), book.getCoverImgUrl(), userBook[position].getCondition(), book.getBookId(), userBook[position].getPrice(), book.getPrice(), true, userBook[position].getPathsToImages());
